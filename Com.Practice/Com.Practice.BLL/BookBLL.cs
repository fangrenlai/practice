...
namespace Com.Practice.BLL
{
	...
	{
		private readonly Com.Practice.DAL.BookDAL dal=new Com.Practice.DAL.BookDAL();
		public BookBLL()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Com.Practice.Model.BookModel GetModelByCache(int id)
		{
			...
			return (Com.Practice.Model.BookModel)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Com.Practice.Model.BookModel> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Com.Practice.Model.BookModel> DataTableToList(DataTable dt)
		{
			List<Com.Practice.Model.BookModel> modelList = new List<Com.Practice.Model.BookModel>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Com.Practice.Model.BookModel model;
